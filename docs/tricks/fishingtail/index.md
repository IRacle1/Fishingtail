...
Эта линка в `PD` конечно не оч возможна, но в `PS` её можно выполнить легко, а если выполним получится:
...
Но на основе моих исследований я пришел к 2 основным теориям фиштейла. Я их взял не из головы: каждая из них высказывалась ранее кем-либо. Но каждая из этих двух теорий в итоге была заигнорена в ноль😠

*Каждая из этих двух теорий логична и имеет право на существование*

### Теория 1: "Олд"

Называется она так, ибо её подразумевали все с самого начала появления фишингов/фиштейлов.
...
(Упрощенное: вариация ликов араунд ~ араунд рев только в `PD`/`PU`)
