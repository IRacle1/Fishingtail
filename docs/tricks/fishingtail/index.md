...
Единственный момент в различии хендмува и ориентации, Если в прошлых вариациях мы видели изменение положения руки только между PD и PU, то в этих вариациях будет изменение между PS и BS (*Для незнающих что такое BS - [тык](TODO:)*)
